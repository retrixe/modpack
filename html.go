...
<body>
  ...
  <p><strong>Can I still use OptiFine on 1.16.4?</strong> Yes, you can download it from <a>https://optifine.net</a> and
  ...
  Hwyla, (lambDynamicLights/Ok Zoomer/Phosphor/Sodium)/OptiFine%2BOptiFabric, LightOverlay, Lithium, MaLiLib,
...
<body>
  ...
  <select id='select-version' name="Minecraft Version" class="browser-default">
    ...
    <option value="1.16.4" selected>1.16.4</option>
  </select>
  <br />
  <br />
